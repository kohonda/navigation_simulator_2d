...
class AgentState(NamedTuple):
    ...
    def __str__(self)->str:
        return "AgentState((x,y,yaw)={}, (vx,vy,w)={})".format(
            [self.pos[0], self.pos[1], self.yaw], [self.linear_vel[0], self.linear_vel[1] , self.angular_vel])
    ...
    def __deepcopy__(self):
        return AgentState(self.pos.copy(), self.yaw , self.linear_vel.copy(), self.angular_vel)